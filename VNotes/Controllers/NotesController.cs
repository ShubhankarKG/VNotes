...
namespace VNotes.Controllers
{
    ...
    {
        private readonly VNotesContext _context;

        public NotesController(VNotesContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Note != null ? 
                          ...
                          Problem("Entity set 'VNotesContext.Note'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'VNotesContext.Note'  is null.");
            }
            var note = await _context.Note.FindAsync(id);
            if (note != null)
            {
